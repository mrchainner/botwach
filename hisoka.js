...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('This bot Script : https://github.com/mrchainner/botwach\n\nAdded  Feature By Mr_chainner\n\n Dont Forget Give Star')
            }
            break
            case 'chat': {
...
break
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/mrchainner/botwach'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 818-301-179'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
...
════════════════════
*Join:* https://chat.whatsapp.com/J4UxmOeoDM2Eb8uGDTxhmA_
*Who's Updated?:* _MrChainner_
════════════════════
...
`
                let btn = [{
                        ...
                        hisoka.send5ButImg(m.chat, anu, 'ChainnerBot ~ Multi Device', global.thumb, btn)
                     }
            break
            default:
                if (budy.startsWith('=>')) {
